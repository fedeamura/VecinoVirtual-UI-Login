const metodos = {
  ...
  toDateArgentina: fechaString => {
    try {
      let partesDia = fechaString.split("/");
  ...
  toDateTimeArgentina: fechaString => {
    try {
      let partesDia = fechaString.split(" ")[0].split("/");
      let partesHora = fechaString.split(" ")[1].split(":");
